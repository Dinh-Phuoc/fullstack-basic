...
export default function Solutions({ handleClose, openSolutionsMenu }) {
    ...
    return (
        <Box sx={{
            ...
            right: 0,
            top: '58px',
            visibility: openSolutionsMenu ? 'visible' : 'hidden',
        ...
        >
            <Box 
                sx={{ 
                    ...
                    display: 'flex',
                    animation: openSolutionsMenu ? `${fadeIn} 0.2s ease forwards` : `${fadeOut} 0.2s ease forwards`,
                    transformOrigin: 'top'
                }}
